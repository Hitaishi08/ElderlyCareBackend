      ...
      <div className="app-container">
        ...
        <div className="sidebar">
          <div className="sidebar-header">
            {isSidebarOpen && <h3>Medicine Tracker</h3>}
        ...
        <div className="main-content">
          <header className="header">
            <h1>Medicine & Prescription Tracker</h1>
            <p>Manage medications with care and precision</p>
          </header>
      ...
      <footer className="footer">
        <div className="footer-container">
          <div className="footer-section">
            <h4>About Us</h4>
            <p>
              Medicine Tracker helps caregivers and families ensure timely medication management with ease and accuracy.
            </p>
          </div>
          <div className="footer-section">
            <h4>Quick Links</h4>
          ...
          <div className="footer-section">
            <h4>Stay Updated</h4>
            <p>Get health tips and updates straight to your inbox!</p>
            <input
              type="email"
            ...
            <button
              style={{
                width: "100%", padding: "12px", marginTop: "10px", background: "#4299E1", color: "#FFFFFF",
                border: "none", borderRadius: "8px", cursor: "pointer", transition: "background 0.2s ease",
              }}
              onMouseOver={(e) => (e.target.style.background = "#48BB78")}
        ...
        <div className="footer-bottom">
          <p>
            © {new Date().getFullYear()} Medicine Tracker. All rights reserved. 
